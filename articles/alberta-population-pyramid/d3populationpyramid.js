...
function PeoplePyramid (data, elementID, unit) {
	...
	var $chart = $container.append('<svg class="pop-pyramid" style="display: block" viewbox="0,0,1000,750"></svg>');
	...
	$container.append('<div id="' + elementID + 'YearControl" style="display: block; text-align: center; width: ' + /*this.width*/'100%' + 'px"></div>');
	...
	$yearControl.append('<div style="display: block; font-family: sans-serif; margin: ' + age.rangeBand()*.55/2 + 'px auto; horizontal-align: center; font-size:' + age.rangeBand()*.45 + 'px">Year</div>')
